...
rativo basato su VQC per la produzione di dati sintetici tabulari fair, analizzandone
e ottimizzandone il trade-off tridimensionale tra espressività dell’ansatz (**utility**),
mitigazione del bias (**fairness**) e interpretabilità del circuito (**explainability**). 
